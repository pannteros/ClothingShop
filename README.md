...
**GR:** Ένα online κατάστημα ρούχων με σύστημα εγγραφής/σύνδεσης χρηστών, προβολή προϊόντων και διαχείριση παραγγελιών. 

**EN:** An online clothing store with user authentication, product browsing and order management. 
---
